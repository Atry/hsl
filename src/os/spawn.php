...
function posix_spawn(
  ...
  $fork_and_execve = _OS\fork_and_execve_with_file_actions($file_actions);
  $options =
    _OS\parse_posix_spawnattr_t(shape('execvpe' => false), $attributes);
...
function posix_spawnp(
  ...
  $fork_and_execve = _OS\fork_and_execve_with_file_actions($file_actions);
  $options = _OS\parse_posix_spawnattr_t(shape('execvpe' => true), $attributes);
  return $fork_and_execve($file, $argv, $envp, dict[], $options);
}
